...
// destroi uma prova
// complexidade caso médio O(n + m) onde n é o número de atletas inscritos na prova e m é o número de salas
// complexidade pior caso O(n + m + k) onde k é o número de atletas em espera
...
// complexidade caso médio: O(1) (se não houver salas com lugares vagos e não houver atletas em espera)
// complexidade pior caso: O(n) (se houver salas com lugares vagos e houver atletas em espera)
